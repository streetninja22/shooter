...
public:
	...
	Animation(std::vector<AnimationFrame> animationTrack, Uint32 defaultFrameDelay = 1) : m_track(animationTrack), m_defaultFrameDelay(defaultFrameDelay), m_clock(0), m_prevFrameTime(0), m_currentFrameIndex(0)
	{
	}
